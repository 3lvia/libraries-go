...
type MeteringPointVersion struct {
	MeteringPoint *UnionNullMeteringPoint `json:"MeteringPoint"`

	Version *UnionNullExternalEvent `json:"Version"`
}

const MeteringPointVersionAvroCRC64Fingerprint = "\x97\x9cת\xdcy=\xeb"

func NewMeteringPointVersion() MeteringPointVersion {
	r := MeteringPointVersion{}
	r.MeteringPoint = nil
	r.Version = nil
	return r
}

func DeserializeMeteringPointVersion(r io.Reader) (MeteringPointVersion, error) {
...
func DeserializeMeteringPointVersionFromSchema(r io.Reader, schema string) (MeteringPointVersion, error) {
	t := NewMeteringPointVersion()
...
func writeMeteringPointVersion(r MeteringPointVersion, w io.Writer) error {
	var err error
	err = writeUnionNullMeteringPoint(r.MeteringPoint, w)
	if err != nil {
		return err
	}
	err = writeUnionNullExternalEvent(r.Version, w)
	if err != nil {
		return err
	}
	return err
...
func (r *MeteringPointVersion) SetDefault(i int) {
	switch i {
	case 0:
		r.MeteringPoint = nil
		return
...
func (r *MeteringPointVersion) NullField(i int) {
	switch i {
	case 0:
		r.MeteringPoint = nil
		return
...
func (_ MeteringPointVersion) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ MeteringPointVersion) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ MeteringPointVersion) HintSize(int)                     { panic("Unsupported operation") }
func (_ MeteringPointVersion) Finalize()                        {}

func (_ MeteringPointVersion) AvroCRC64Fingerprint() []byte {
	return []byte(MeteringPointVersionAvroCRC64Fingerprint)
}

func (r MeteringPointVersion) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *MeteringPointVersion) UnmarshalJSON(data []byte) error {
