...
const InnflyttAvroCRC64Fingerprint = "C\xb7`\x8ad\xfc\xed\x8c"

func NewInnflytt() Innflytt {
	r := Innflytt{}
	r.Avtale = NewAvtale()
...
func DeserializeInnflytt(r io.Reader) (Innflytt, error) {
	t := NewInnflytt()
...
func DeserializeInnflyttFromSchema(r io.Reader, schema string) (Innflytt, error) {
	t := NewInnflytt()
...
func writeInnflytt(r Innflytt, w io.Writer) error {
	var err error
...
func (r *Innflytt) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *Innflytt) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ Innflytt) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ Innflytt) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ Innflytt) HintSize(int)                     { panic("Unsupported operation") }
func (_ Innflytt) Finalize()                        {}

func (_ Innflytt) AvroCRC64Fingerprint() []byte {
	return []byte(InnflyttAvroCRC64Fingerprint)
}

func (r Innflytt) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *Innflytt) UnmarshalJSON(data []byte) error {
