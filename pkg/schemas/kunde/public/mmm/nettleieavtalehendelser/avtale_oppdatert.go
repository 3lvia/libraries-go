...
const AvtaleOppdatertAvroCRC64Fingerprint = "/\x95L\x9a\xa2\xc6\xda\xed"

func NewAvtaleOppdatert() AvtaleOppdatert {
	r := AvtaleOppdatert{}
	r.Avtale = NewAvtale()
...
func DeserializeAvtaleOppdatert(r io.Reader) (AvtaleOppdatert, error) {
...
func DeserializeAvtaleOppdatertFromSchema(r io.Reader, schema string) (AvtaleOppdatert, error) {
	t := NewAvtaleOppdatert()
...
func writeAvtaleOppdatert(r AvtaleOppdatert, w io.Writer) error {
	var err error
...
func (r *AvtaleOppdatert) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *AvtaleOppdatert) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ AvtaleOppdatert) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ AvtaleOppdatert) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ AvtaleOppdatert) HintSize(int)                     { panic("Unsupported operation") }
func (_ AvtaleOppdatert) Finalize()                        {}

func (_ AvtaleOppdatert) AvroCRC64Fingerprint() []byte {
	return []byte(AvtaleOppdatertAvroCRC64Fingerprint)
}

func (r AvtaleOppdatert) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *AvtaleOppdatert) UnmarshalJSON(data []byte) error {
