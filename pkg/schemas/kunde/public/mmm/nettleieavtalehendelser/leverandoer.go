...
const LeverandoerAvroCRC64Fingerprint = "\x04X;͈\xf7-\xc7"
...
func (r Leverandoer) Schema() string {
	return "{\"fields\":[{\"name\":\"Gln\",\"type\":\"string\"},{\"name\":\"Startdato\",\"type\":{\"logicalType\":\"timestamp-millis\",\"type\":\"long\"}}],\"name\":\"Mmm.Schemas.NettleieAvtaleHendelser.V1.Leverandoer\",\"type\":\"record\"}"
}

func (r Leverandoer) SchemaName() string {
	return "Mmm.Schemas.NettleieAvtaleHendelser.V1.Leverandoer"
}
