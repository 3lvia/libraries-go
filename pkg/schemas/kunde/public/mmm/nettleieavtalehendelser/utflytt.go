...
const UtflyttAvroCRC64Fingerprint = "\x95\xd2\x0e1\xf9Bh\xbb"

func NewUtflytt() Utflytt {
	r := Utflytt{}
	r.Avtale = NewAvtale()
...
func DeserializeUtflytt(r io.Reader) (Utflytt, error) {
	t := NewUtflytt()
...
func DeserializeUtflyttFromSchema(r io.Reader, schema string) (Utflytt, error) {
	t := NewUtflytt()
...
func writeUtflytt(r Utflytt, w io.Writer) error {
	var err error
...
func (r *Utflytt) SetDefault(i int) {
	switch i {
	}
	panic("Unknown field index")
}

func (r *Utflytt) NullField(i int) {
	switch i {
	}
	panic("Not a nullable field index")
}

func (_ Utflytt) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ Utflytt) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ Utflytt) HintSize(int)                     { panic("Unsupported operation") }
func (_ Utflytt) Finalize()                        {}

func (_ Utflytt) AvroCRC64Fingerprint() []byte {
	return []byte(UtflyttAvroCRC64Fingerprint)
}

func (r Utflytt) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *Utflytt) UnmarshalJSON(data []byte) error {
