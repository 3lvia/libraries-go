...
const KontaktinformasjonAvroCRC64Fingerprint = "}U\x0f\xebeu\xa0\x18"
...
func (r Kontaktinformasjon) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"Beskrivelse\",\"type\":[\"null\",\"string\"]},{\"name\":\"KommunikasjonsType\",\"type\":{\"name\":\"KommunikasjonsType\",\"symbols\":[\"Mobil\",\"Telefon\",\"Epost\",\"Telefax\"],\"type\":\"enum\"}},{\"name\":\"Verdi\",\"type\":\"string\"}],\"name\":\"Mmm.Schemas.NettleieAvtaleHendelser.V1.Kontaktinformasjon\",\"type\":\"record\"}"
}

func (r Kontaktinformasjon) SchemaName() string {
	return "Mmm.Schemas.NettleieAvtaleHendelser.V1.Kontaktinformasjon"
}
