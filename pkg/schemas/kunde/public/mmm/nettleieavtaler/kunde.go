...
type Kunde struct {
	...
	Foedselsnummer *UnionNullString `json:"Foedselsnummer"`

	Fornavn *UnionNullString `json:"Fornavn"`

	KundeGuid string `json:"KundeGuid"`

	Organisasjonsnummer *UnionNullString `json:"Organisasjonsnummer"`

	Virksomhetsnavn *UnionNullString `json:"Virksomhetsnavn"`
}

const KundeAvroCRC64Fingerprint = "te\xaa\xa5\\\xf4t|"

func NewKunde() Kunde {
	r := Kunde{}
	r.Etternavn = nil
	r.Foedselsnummer = nil
	r.Fornavn = nil
	r.Organisasjonsnummer = nil
...
func writeKunde(r Kunde, w io.Writer) error {
	...
	err = writeUnionNullString(r.Foedselsnummer, w)
	if err != nil {
		return err
	}
	...
	err = writeUnionNullString(r.Organisasjonsnummer, w)
	if err != nil {
		return err
	}
...
func (r Kunde) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"Etternavn\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Foedselsnummer\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Fornavn\",\"type\":[\"null\",\"string\"]},{\"name\":\"KundeGuid\",\"type\":{\"logicalType\":\"uuid\",\"type\":\"string\"}},{\"default\":null,\"name\":\"Organisasjonsnummer\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Virksomhetsnavn\",\"type\":[\"null\",\"string\"]}],\"name\":\"Mmm.Schemas.NettleieAvtale.V1.Kunde\",\"type\":\"record\"}"
}

func (r Kunde) SchemaName() string {
	return "Mmm.Schemas.NettleieAvtale.V1.Kunde"
}
...
func (r *Kunde) Get(i int) types.Field {
	...
	case 0:
		...
		return r.Etternavn
	case 1:
		r.Foedselsnummer = NewUnionNullString()

		return r.Foedselsnummer
	case 2:
	...
	case 4:
		r.Organisasjonsnummer = NewUnionNullString()

		return r.Organisasjonsnummer
	case 5:
...
func (r Kunde) MarshalJSON() ([]byte, error) {
	...
	output["Foedselsnummer"], err = json.Marshal(r.Foedselsnummer)
	if err != nil {
		return nil, err
	}
	...
	output["Organisasjonsnummer"], err = json.Marshal(r.Organisasjonsnummer)
	if err != nil {
		return nil, err
	}
...
func (r *Kunde) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["Foedselsnummer"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.Foedselsnummer); err != nil {
			return err
		}
	} else {
		r.Foedselsnummer = NewUnionNullString()
	...
	val = func() json.RawMessage {
		if v, ok := fields["Organisasjonsnummer"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.Organisasjonsnummer); err != nil {
			return err
		}
	} else {
		r.Organisasjonsnummer = NewUnionNullString()
