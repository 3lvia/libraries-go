...
func (r *UnionNullCustomer) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullCustomerTypeEnumCustomer:
		return json.Marshal(map[string]interface{}{"kunde_extensions_wop_api.Model.Customer": r.Customer})
	}
...
func (r *UnionNullCustomer) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["kunde_extensions_wop_api.Model.Customer"]; ok {
		r.UnionType = 1
