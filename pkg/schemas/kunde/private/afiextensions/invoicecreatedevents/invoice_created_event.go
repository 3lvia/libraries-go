...
type InvoiceCreatedEvent struct {
	...
	Invoice *UnionNullInvoice `json:"Invoice"`
...
const InvoiceCreatedEventAvroCRC64Fingerprint = "\xcb\xcbj\xae3|DO"

func NewInvoiceCreatedEvent() InvoiceCreatedEvent {
	r := InvoiceCreatedEvent{}
	r.AccountCode = nil
	r.ActorId = nil
	r.Cid = nil
	r.CreatedTime = nil
...
func DeserializeInvoiceCreatedEvent(r io.Reader) (InvoiceCreatedEvent, error) {
	t := NewInvoiceCreatedEvent()
...
func DeserializeInvoiceCreatedEventFromSchema(r io.Reader, schema string) (InvoiceCreatedEvent, error) {
	t := NewInvoiceCreatedEvent()
...
func writeInvoiceCreatedEvent(r InvoiceCreatedEvent, w io.Writer) error {
	var err error
	...
	err = writeUnionNullInvoice(r.Invoice, w)
	if err != nil {
		return err
	}
...
func (r *InvoiceCreatedEvent) SetDefault(i int) {
	switch i {
	case 0:
		r.AccountCode = nil
		return
...
func (r *InvoiceCreatedEvent) NullField(i int) {
	switch i {
	case 0:
		r.AccountCode = nil
		return
...
func (_ InvoiceCreatedEvent) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ InvoiceCreatedEvent) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ InvoiceCreatedEvent) HintSize(int)                     { panic("Unsupported operation") }
func (_ InvoiceCreatedEvent) Finalize()                        {}

func (_ InvoiceCreatedEvent) AvroCRC64Fingerprint() []byte {
	return []byte(InvoiceCreatedEventAvroCRC64Fingerprint)
}

func (r InvoiceCreatedEvent) MarshalJSON() ([]byte, error) {
	var err error
...
func (r *InvoiceCreatedEvent) UnmarshalJSON(data []byte) error {
