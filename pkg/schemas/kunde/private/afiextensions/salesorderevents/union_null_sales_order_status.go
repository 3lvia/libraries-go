...
func (r *UnionNullSalesOrderStatus) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullSalesOrderStatusTypeEnumSalesOrderStatus:
		return json.Marshal(map[string]interface{}{"Afiextensions.Schemas.SalesOrderEvents.V1.SalesOrderStatus": r.SalesOrderStatus})
	}
...
func (r *UnionNullSalesOrderStatus) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Afiextensions.Schemas.SalesOrderEvents.V1.SalesOrderStatus"]; ok {
		r.UnionType = 1
