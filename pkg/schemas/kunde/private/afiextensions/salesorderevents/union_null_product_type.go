...
func (r *UnionNullProductType) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullProductTypeTypeEnumProductType:
		return json.Marshal(map[string]interface{}{"Afiextensions.Schemas.SalesOrderEvents.V1.ProductType": r.ProductType})
	}
...
func (r *UnionNullProductType) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Afiextensions.Schemas.SalesOrderEvents.V1.ProductType"]; ok {
		r.UnionType = 1
