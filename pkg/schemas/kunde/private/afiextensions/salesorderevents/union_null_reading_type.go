...
func (r *UnionNullReadingType) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullReadingTypeTypeEnumReadingType:
		return json.Marshal(map[string]interface{}{"Afiextensions.Schemas.SalesOrderEvents.V1.ReadingType": r.ReadingType})
	}
...
func (r *UnionNullReadingType) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Afiextensions.Schemas.SalesOrderEvents.V1.ReadingType"]; ok {
		r.UnionType = 1
