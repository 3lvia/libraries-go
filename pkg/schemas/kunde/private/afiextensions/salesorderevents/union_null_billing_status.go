...
func (r *UnionNullBillingStatus) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullBillingStatusTypeEnumBillingStatus:
		return json.Marshal(map[string]interface{}{"Afiextensions.Schemas.SalesOrderEvents.V1.BillingStatus": r.BillingStatus})
	}
...
func (r *UnionNullBillingStatus) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Afiextensions.Schemas.SalesOrderEvents.V1.BillingStatus"]; ok {
		r.UnionType = 1
