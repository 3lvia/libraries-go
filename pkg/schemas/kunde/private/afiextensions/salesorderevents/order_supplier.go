...
const OrderSupplierAvroCRC64Fingerprint = "\x83M@\x95\x12\xabUl"
...
func (r OrderSupplier) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"FromDate\",\"type\":[\"null\",\"string\"]},{\"name\":\"HourlyRead\",\"type\":\"boolean\"},{\"default\":null,\"name\":\"SettlementMethod\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"SupplierId\",\"type\":[\"null\",\"int\"]},{\"default\":null,\"name\":\"ToDate\",\"type\":[\"null\",\"string\"]}],\"name\":\"Afiextensions.Schemas.SalesOrderEvents.V1.OrderSupplier\",\"type\":\"record\"}"
}

func (r OrderSupplier) SchemaName() string {
	return "Afiextensions.Schemas.SalesOrderEvents.V1.OrderSupplier"
}
