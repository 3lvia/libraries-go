...
func (r *UnionNullCommunicationChannelType) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullCommunicationChannelTypeTypeEnumCommunicationChannelType:
		return json.Marshal(map[string]interface{}{"Afiextensions.Schemas.SalesOrderEvents.V1.CommunicationChannelType": r.CommunicationChannelType})
	}
...
func (r *UnionNullCommunicationChannelType) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Afiextensions.Schemas.SalesOrderEvents.V1.CommunicationChannelType"]; ok {
		r.UnionType = 1
