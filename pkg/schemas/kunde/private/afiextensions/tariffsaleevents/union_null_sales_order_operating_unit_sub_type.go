...
func (r *UnionNullSalesOrderOperatingUnitSubType) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullSalesOrderOperatingUnitSubTypeTypeEnumSalesOrderOperatingUnitSubType:
		return json.Marshal(map[string]interface{}{"Afiextensions.Schemas.TariffEvents.V1.SalesOrderOperatingUnitSubType": r.SalesOrderOperatingUnitSubType})
	}
...
func (r *UnionNullSalesOrderOperatingUnitSubType) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Afiextensions.Schemas.TariffEvents.V1.SalesOrderOperatingUnitSubType"]; ok {
		r.UnionType = 1
