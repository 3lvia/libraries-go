...
type Counter struct {
	CounterClassificationId *UnionNullInt `json:"CounterClassificationId"`

	CounterCodeId *UnionNullInt `json:"CounterCodeId"`

	CustomProductCode *UnionNullInt `json:"CustomProductCode"`
...
const CounterAvroCRC64Fingerprint = ".\x01Z=\x9b\xba\x8f-"

func NewCounter() Counter {
	r := Counter{}
	r.CounterClassificationId = nil
	r.CounterCodeId = nil
	r.CustomProductCode = nil
...
func writeCounter(r Counter, w io.Writer) error {
	var err error
	err = writeUnionNullInt(r.CounterClassificationId, w)
	if err != nil {
		return err
	}
	err = writeUnionNullInt(r.CounterCodeId, w)
	if err != nil {
		return err
	}
	err = writeUnionNullInt(r.CustomProductCode, w)
	if err != nil {
		return err
	}
...
func (r *Counter) Get(i int) types.Field {
	switch i {
	case 0:
		r.CounterClassificationId = NewUnionNullInt()

		return r.CounterClassificationId
	case 1:
		r.CounterCodeId = NewUnionNullInt()

		return r.CounterCodeId
	case 2:
		r.CustomProductCode = NewUnionNullInt()

		return r.CustomProductCode
	case 3:
...
func (r Counter) MarshalJSON() ([]byte, error) {
	...
	output["CounterClassificationId"], err = json.Marshal(r.CounterClassificationId)
	if err != nil {
		return nil, err
	}
	output["CounterCodeId"], err = json.Marshal(r.CounterCodeId)
	if err != nil {
		return nil, err
	}
	output["CustomProductCode"], err = json.Marshal(r.CustomProductCode)
	if err != nil {
		return nil, err
	}
...
func (r *Counter) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["CounterClassificationId"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.CounterClassificationId); err != nil {
			return err
		}
	} else {
		r.CounterClassificationId = NewUnionNullInt()
	...
	val = func() json.RawMessage {
		if v, ok := fields["CounterCodeId"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.CounterCodeId); err != nil {
			return err
		}
	} else {
		r.CounterCodeId = NewUnionNullInt()
	...
	val = func() json.RawMessage {
		if v, ok := fields["CustomProductCode"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.CustomProductCode); err != nil {
			return err
		}
	} else {
		r.CustomProductCode = NewUnionNullInt()
