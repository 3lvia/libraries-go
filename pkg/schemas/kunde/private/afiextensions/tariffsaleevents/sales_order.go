...
type SalesOrder struct {
	...
	NotificationEffectLimit *UnionNullDouble `json:"NotificationEffectLimit"`
	...
	ProductionPercentage *UnionNullDouble `json:"ProductionPercentage"`
...
const SalesOrderAvroCRC64Fingerprint = "\x02\x8eV%\x06\x06c\xe5"
...
func writeSalesOrder(r SalesOrder, w io.Writer) error {
	...
	err = writeUnionNullDouble(r.NotificationEffectLimit, w)
	if err != nil {
		return err
	}
	...
	err = writeUnionNullDouble(r.ProductionPercentage, w)
	if err != nil {
		return err
	}
...
func (r *SalesOrder) Get(i int) types.Field {
	...
	case 16:
		r.NotificationEffectLimit = NewUnionNullDouble()
	...
	case 20:
		r.ProductionPercentage = NewUnionNullDouble()
