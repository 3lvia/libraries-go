...
const MoneyAvroCRC64Fingerprint = "\")\xdfv\xfdYH\xb4"
...
func (r Money) Schema() string {
	return "{\"fields\":[{\"name\":\"Amount\",\"type\":{\"logicalType\":\"decimal\",\"precision\":29,\"scale\":14,\"type\":\"bytes\"}},{\"default\":null,\"name\":\"CurrencyCode\",\"type\":[\"null\",\"string\"]}],\"name\":\"Afiextensions.Schemas.InvoicePostedEvents.V1.Money\",\"type\":\"record\"}"
}

func (r Money) SchemaName() string {
	return "Afiextensions.Schemas.InvoicePostedEvents.V1.Money"
}
