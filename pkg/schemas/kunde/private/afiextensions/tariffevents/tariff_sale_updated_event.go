...
type TariffSaleUpdatedEvent struct {
	...
	ToDate *UnionNullLong `json:"ToDate"`

	UpdatedTime *UnionNullLong `json:"UpdatedTime"`
}

const TariffSaleUpdatedEventAvroCRC64Fingerprint = "\xc9\x1b?^s\xb9\x01\x94"
...
func writeTariffSaleUpdatedEvent(r TariffSaleUpdatedEvent, w io.Writer) error {
	...
	err = writeUnionNullLong(r.ToDate, w)
	if err != nil {
		return err
	}
