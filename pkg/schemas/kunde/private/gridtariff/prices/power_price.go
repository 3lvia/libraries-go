...
type PowerPrice struct {
	...
	MonthlyActivePowerExTaxes float64 `json:"MonthlyActivePowerExTaxes"`

	MonthlyReactivePowerExTaxes *UnionNullDouble `json:"MonthlyReactivePowerExTaxes"`
...
const PowerPriceAvroCRC64Fingerprint = "ϟ\x17\x89\xc5\xf4\xb6i"

func NewPowerPrice() PowerPrice {
	r := PowerPrice{}
	r.Currency = nil
	r.Id = nil
	r.LevelInfo = nil
	r.MonetaryUnitOfMeasure = nil
	r.MonthlyReactivePowerExTaxes = nil
...
func DeserializePowerPrice(r io.Reader) (PowerPrice, error) {
	t := NewPowerPrice()
...
func DeserializePowerPriceFromSchema(r io.Reader, schema string) (PowerPrice, error) {
	t := NewPowerPrice()
...
func writePowerPrice(r PowerPrice, w io.Writer) error {
	var err error
	...
	err = vm.WriteDouble(r.MonthlyActivePowerExTaxes, w)
	if err != nil {
		return err
	}
	err = writeUnionNullDouble(r.MonthlyReactivePowerExTaxes, w)
	if err != nil {
		return err
	}
...
func (r PowerPrice) Serialize(w io.Writer) error {
	return writePowerPrice(r, w)
}

func (r PowerPrice) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"Currency\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Id\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"LevelInfo\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"MonetaryUnitOfMeasure\",\"type\":[\"null\",\"string\"]},{\"name\":\"MonthlyActivePowerExTaxes\",\"type\":\"double\"},{\"default\":null,\"name\":\"MonthlyReactivePowerExTaxes\",\"type\":[\"null\",\"double\"]},{\"default\":null,\"name\":\"MonthlyUnitOfMeasure\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"NextIdDown\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"NextIdUp\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"ValueMax\",\"type\":[\"null\",\"double\"]},{\"default\":null,\"name\":\"ValueMin\",\"type\":[\"null\",\"double\"]},{\"default\":null,\"name\":\"ValueUnitOfMeasure\",\"type\":[\"null\",\"string\"]}],\"name\":\"GridTariff.Events.V1.PowerPrice\",\"type\":\"record\"}"
}

func (r PowerPrice) SchemaName() string {
	return "GridTariff.Events.V1.PowerPrice"
}

func (_ PowerPrice) SetBoolean(v bool)    { panic("Unsupported operation") }
func (_ PowerPrice) SetInt(v int32)       { panic("Unsupported operation") }
func (_ PowerPrice) SetLong(v int64)      { panic("Unsupported operation") }
func (_ PowerPrice) SetFloat(v float32)   { panic("Unsupported operation") }
func (_ PowerPrice) SetDouble(v float64)  { panic("Unsupported operation") }
func (_ PowerPrice) SetBytes(v []byte)    { panic("Unsupported operation") }
func (_ PowerPrice) SetString(v string)   { panic("Unsupported operation") }
func (_ PowerPrice) SetUnionElem(v int64) { panic("Unsupported operation") }

func (r *PowerPrice) Get(i int) types.Field {
	switch i {
	case 0:
	...
	case 4:
		w := types.Double{Target: &r.MonthlyActivePowerExTaxes}

		return w

	case 5:
		r.MonthlyReactivePowerExTaxes = NewUnionNullDouble()

		return r.MonthlyReactivePowerExTaxes
	case 6:
...
func (r *PowerPrice) SetDefault(i int) {
	switch i {
	case 0:
		r.Currency = nil
		return
...
func (r *PowerPrice) NullField(i int) {
	switch i {
	case 0:
		r.Currency = nil
		return
...
func (_ PowerPrice) AppendMap(key string) types.Field { panic("Unsupported operation") }
func (_ PowerPrice) AppendArray() types.Field         { panic("Unsupported operation") }
func (_ PowerPrice) HintSize(int)                     { panic("Unsupported operation") }
func (_ PowerPrice) Finalize()                        {}

func (_ PowerPrice) AvroCRC64Fingerprint() []byte {
	return []byte(PowerPriceAvroCRC64Fingerprint)
}

func (r PowerPrice) MarshalJSON() ([]byte, error) {
	var err error
	...
	output["MonthlyActivePowerExTaxes"], err = json.Marshal(r.MonthlyActivePowerExTaxes)
	if err != nil {
		return nil, err
	}
	output["MonthlyReactivePowerExTaxes"], err = json.Marshal(r.MonthlyReactivePowerExTaxes)
	if err != nil {
		return nil, err
	}
...
func (r *PowerPrice) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["MonthlyActivePowerExTaxes"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.MonthlyActivePowerExTaxes); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for MonthlyActivePowerExTaxes")
	}
	val = func() json.RawMessage {
		if v, ok := fields["MonthlyReactivePowerExTaxes"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.MonthlyReactivePowerExTaxes); err != nil {
			return err
		}
	} else {
		r.MonthlyReactivePowerExTaxes = NewUnionNullDouble()
