...
func (r *UnionNullAssetObject) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullAssetObjectTypeEnumAssetObject:
		return json.Marshal(map[string]interface{}{"Skogshorn.Nett.Schemas.Enitites.AssetObject": r.AssetObject})
	}
...
func (r *UnionNullAssetObject) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Skogshorn.Nett.Schemas.Enitites.AssetObject"]; ok {
		r.UnionType = 1
