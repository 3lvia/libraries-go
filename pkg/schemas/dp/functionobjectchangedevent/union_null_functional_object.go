...
func (r *UnionNullFunctionalObject) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullFunctionalObjectTypeEnumFunctionalObject:
		return json.Marshal(map[string]interface{}{"Skogshorn.Nett.Schemas.Enitites.FunctionalObject": r.FunctionalObject})
	}
...
func (r *UnionNullFunctionalObject) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Skogshorn.Nett.Schemas.Enitites.FunctionalObject"]; ok {
		r.UnionType = 1
