...
func (r *UnionNullData) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullDataTypeEnumData:
		return json.Marshal(map[string]interface{}{"LvisToMsi.Kafka.Dto.Data": r.Data})
	}
...
func (r *UnionNullData) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["LvisToMsi.Kafka.Dto.Data"]; ok {
		r.UnionType = 1
