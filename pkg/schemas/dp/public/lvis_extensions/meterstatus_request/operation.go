...
const OperationAvroCRC64Fingerprint = "\xeahu\x93\x8d\xa0\x7f\xcb"
...
func (r Operation) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"CorrelationId\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"MessageType\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Type\",\"type\":[\"null\",\"string\"]}],\"name\":\"LvisToMsi.Kafka.Dto.Operation\",\"type\":\"record\"}"
}

func (r Operation) SchemaName() string {
	return "LvisToMsi.Kafka.Dto.Operation"
}
