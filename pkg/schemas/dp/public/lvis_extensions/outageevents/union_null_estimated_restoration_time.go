...
func (r *UnionNullEstimatedRestorationTime) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullEstimatedRestorationTimeTypeEnumEstimatedRestorationTime:
		return json.Marshal(map[string]interface{}{"OutageEventsLvisToElvia.Kafka.Dto.EstimatedRestorationTime": r.EstimatedRestorationTime})
	}
...
func (r *UnionNullEstimatedRestorationTime) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["OutageEventsLvisToElvia.Kafka.Dto.EstimatedRestorationTime"]; ok {
		r.UnionType = 1
