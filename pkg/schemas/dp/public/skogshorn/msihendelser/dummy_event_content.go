...
const DummyEventContentAvroCRC64Fingerprint = "K\x99\x8d\x16-\xde\xff\xbc"
...
func (r DummyEventContent) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"ObjectValue\",\"type\":[\"null\",\"string\"]}],\"name\":\"Skogshorn.MSI.Common.Database.Entity.DummyEventContent\",\"type\":\"record\"}"
}

func (r DummyEventContent) SchemaName() string {
	return "Skogshorn.MSI.Common.Database.Entity.DummyEventContent"
}
