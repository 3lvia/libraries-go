...
const DummyEventHeaderAvroCRC64Fingerprint = "\xebv~o\xba\x03YY"
...
func (r DummyEventHeader) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"EventId\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"EventName\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Source\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"TimeStamp\",\"type\":[\"null\",\"string\"]}],\"name\":\"Skogshorn.MSI.Common.Database.Entity.DummyEventHeader\",\"type\":\"record\"}"
}

func (r DummyEventHeader) SchemaName() string {
	return "Skogshorn.MSI.Common.Database.Entity.DummyEventHeader"
}
