...
const DummyEventHeaderAvroCRC64Fingerprint = "\xd4\x17K)\x88\xf5i2"
...
func (r DummyEventHeader) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"EventId\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"EventName\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Source\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"TimeStamp\",\"type\":[\"null\",\"string\"]}],\"name\":\"Skogshorn.Kunde.Common.Database.Entity.DummyEventHeader\",\"type\":\"record\"}"
}

func (r DummyEventHeader) SchemaName() string {
	return "Skogshorn.Kunde.Common.Database.Entity.DummyEventHeader"
}
