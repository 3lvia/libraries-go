...
const DummyEventContentAvroCRC64Fingerprint = "N\x956CL\x8c \x16"
...
func (r DummyEventContent) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"ObjectValue\",\"type\":[\"null\",\"string\"]}],\"name\":\"Skogshorn.Kunde.Common.Database.Entity.DummyEventContent\",\"type\":\"record\"}"
}

func (r DummyEventContent) SchemaName() string {
	return "Skogshorn.Kunde.Common.Database.Entity.DummyEventContent"
}
