...
func (r *UnionNullEventContent) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullEventContentTypeEnumEventContent:
		return json.Marshal(map[string]interface{}{"Skogshorn.Nett.Generated.Schemas.Enitites.EventContent": r.EventContent})
	}
...
func (r *UnionNullEventContent) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Skogshorn.Nett.Generated.Schemas.Enitites.EventContent"]; ok {
		r.UnionType = 1
