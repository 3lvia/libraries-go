...
func (r *UnionNullPlant) Schema() string {
	return "[\"null\",{\"fields\":[{\"default\":null,\"name\":\"Created\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"FunctionalObjectId\",\"type\":[\"null\",\"string\"]},{\"name\":\"FuseSize\",\"type\":\"int\"},{\"name\":\"NominalVoltage\",\"type\":\"int\"},{\"name\":\"Phases\",\"type\":\"int\"},{\"default\":null,\"name\":\"PlantId\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Updated\",\"type\":[\"null\",\"string\"]}],\"name\":\"Plant\",\"type\":\"record\"}]"
}
...
func (r *UnionNullPlant) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullPlantTypeEnumPlant:
		return json.Marshal(map[string]interface{}{"Skogshorn.Nett.Generated.Schemas.Enitites.Plant": r.Plant})
	}
...
func (r *UnionNullPlant) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Skogshorn.Nett.Generated.Schemas.Enitites.Plant"]; ok {
		r.UnionType = 1
