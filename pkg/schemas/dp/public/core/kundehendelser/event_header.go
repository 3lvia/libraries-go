...
const EventHeaderAvroCRC64Fingerprint = "\xc0\x81\xcc#\xcf\x1d\x98\xaa"
...
func (r EventHeader) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"EventId\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"EventName\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Source\",\"type\":[\"null\",\"string\"]},{\"name\":\"TimeStamp\",\"type\":\"string\"}],\"name\":\"Skogshorn.Kunde.Schemas.Events.EventHeader\",\"type\":\"record\"}"
}

func (r EventHeader) SchemaName() string {
	return "Skogshorn.Kunde.Schemas.Events.EventHeader"
}
