...
func (r *UnionNullEventHeader) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullEventHeaderTypeEnumEventHeader:
		return json.Marshal(map[string]interface{}{"Skogshorn.Kunde.Schemas.Events.EventHeader": r.EventHeader})
	}
...
func (r *UnionNullEventHeader) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Skogshorn.Kunde.Schemas.Events.EventHeader"]; ok {
		r.UnionType = 1
