...
type Communication struct {
	CommucationType CommunicationType `json:"CommucationType"`
...
const CommunicationAvroCRC64Fingerprint = "\xa0\x03\\\xe1\xa6%\xee\x0f"
...
func writeCommunication(r Communication, w io.Writer) error {
	var err error
	err = writeCommunicationType(r.CommucationType, w)
	if err != nil {
		return err
	}
	err = vm.WriteInt(r.CommunicationId, w)
	if err != nil {
		return err
	}
...
func (r Communication) Schema() string {
	return "{\"fields\":[{\"name\":\"CommucationType\",\"type\":{\"name\":\"CommunicationType\",\"symbols\":[\"Email\",\"Phone\"],\"type\":\"enum\"}},{\"name\":\"CommunicationId\",\"type\":\"int\"},{\"default\":null,\"name\":\"Description\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Value\",\"type\":[\"null\",\"string\"]}],\"name\":\"Skogshorn.Kunde.Schemas.Entities.Communication\",\"type\":\"record\"}"
}

func (r Communication) SchemaName() string {
	return "Skogshorn.Kunde.Schemas.Entities.Communication"
}
...
func (r *Communication) Get(i int) types.Field {
	switch i {
	case 0:
		w := CommunicationTypeWrapper{Target: &r.CommucationType}

		return w

	case 1:
		w := types.Int{Target: &r.CommunicationId}
...
func (r Communication) MarshalJSON() ([]byte, error) {
	...
	output["CommucationType"], err = json.Marshal(r.CommucationType)
	if err != nil {
		return nil, err
	}
...
func (r *Communication) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["CommucationType"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.CommucationType); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for CommucationType")
	}
	val = func() json.RawMessage {
