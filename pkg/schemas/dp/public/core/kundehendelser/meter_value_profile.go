...
type MeterValueProfile struct {
	MeterValueProfileId int32 `json:"MeterValueProfileId"`
...
const MeterValueProfileAvroCRC64Fingerprint = "\x8f\xa3Q\xeb\xb5D\xd4o"
...
func writeMeterValueProfile(r MeterValueProfile, w io.Writer) error {
	var err error
	err = vm.WriteInt(r.MeterValueProfileId, w)
	if err != nil {
		return err
	}
...
func (r MeterValueProfile) Schema() string {
	return "{\"fields\":[{\"name\":\"MeterValueProfileId\",\"type\":\"int\"},{\"default\":null,\"name\":\"Method\",\"type\":[\"null\",{\"name\":\"Method\",\"symbols\":[\"Automatic\",\"Manual\"],\"type\":\"enum\"}]},{\"default\":null,\"name\":\"Resolution\",\"type\":[\"null\",{\"name\":\"MeterValueResolution\",\"symbols\":[\"Quarterly\",\"Hourly\"],\"type\":\"enum\"}]}],\"name\":\"Skogshorn.Kunde.Schemas.Entities.MeterValueProfile\",\"type\":\"record\"}"
}

func (r MeterValueProfile) SchemaName() string {
	return "Skogshorn.Kunde.Schemas.Entities.MeterValueProfile"
}
...
func (r *MeterValueProfile) Get(i int) types.Field {
	switch i {
	case 0:
		w := types.Int{Target: &r.MeterValueProfileId}
...
func (r MeterValueProfile) MarshalJSON() ([]byte, error) {
	...
	output["MeterValueProfileId"], err = json.Marshal(r.MeterValueProfileId)
	if err != nil {
		return nil, err
	}
...
func (r *MeterValueProfile) UnmarshalJSON(data []byte) error {
	...
	val = func() json.RawMessage {
		if v, ok := fields["MeterValueProfileId"]; ok {
			return v
		}
		return nil
	}()
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.MeterValueProfileId); err != nil {
			return err
		}
	} else {
		return fmt.Errorf("no value specified for MeterValueProfileId")
	}
	val = func() json.RawMessage {
