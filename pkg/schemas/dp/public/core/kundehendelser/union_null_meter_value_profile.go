...
func (r *UnionNullMeterValueProfile) Schema() string {
	return "[\"null\",{\"fields\":[{\"name\":\"MeterValueProfileId\",\"type\":\"int\"},{\"default\":null,\"name\":\"Method\",\"type\":[\"null\",{\"name\":\"Method\",\"symbols\":[\"Automatic\",\"Manual\"],\"type\":\"enum\"}]},{\"default\":null,\"name\":\"Resolution\",\"type\":[\"null\",{\"name\":\"MeterValueResolution\",\"symbols\":[\"Quarterly\",\"Hourly\"],\"type\":\"enum\"}]}],\"name\":\"MeterValueProfile\",\"type\":\"record\"}]"
}
...
func (r *UnionNullMeterValueProfile) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullMeterValueProfileTypeEnumMeterValueProfile:
		return json.Marshal(map[string]interface{}{"Skogshorn.Kunde.Schemas.Entities.MeterValueProfile": r.MeterValueProfile})
	}
...
func (r *UnionNullMeterValueProfile) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["Skogshorn.Kunde.Schemas.Entities.MeterValueProfile"]; ok {
		r.UnionType = 1
