...
func (r *UnionNullEventHeader) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullEventHeaderTypeEnumEventHeader:
		return json.Marshal(map[string]interface{}{"UniqueId.Infrastructure.Kafka.Events.EventHeader": r.EventHeader})
	}
...
func (r *UnionNullEventHeader) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["UniqueId.Infrastructure.Kafka.Events.EventHeader"]; ok {
		r.UnionType = 1
