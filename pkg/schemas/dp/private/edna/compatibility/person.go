...
type Person struct {
	BrandNew2 *UnionNullString `json:"BrandNew2"`
...
const PersonAvroCRC64Fingerprint = "w}\xaeY\x86;\x85g"
...
func writePerson(r Person, w io.Writer) error {
	var err error
	err = writeUnionNullString(r.BrandNew2, w)
	if err != nil {
		return err
	}
...
func (r Person) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"BrandNew2\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"FirstName\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"Id\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"LastName\",\"type\":[\"null\",\"string\"]}],\"name\":\"Publisher.Model.Person\",\"type\":\"record\"}"
}
...
func (r *Person) Get(i int) types.Field {
	switch i {
	case 0:
		r.BrandNew2 = NewUnionNullString()
...
func (r Person) MarshalJSON() ([]byte, error) {
	...
	output["BrandNew2"], err = json.Marshal(r.BrandNew2)
	if err != nil {
		return nil, err
	}
...
func (r *Person) UnmarshalJSON(data []byte) error {
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.BrandNew2); err != nil {
			return err
		}
	} else {
		r.BrandNew2 = NewUnionNullString()
