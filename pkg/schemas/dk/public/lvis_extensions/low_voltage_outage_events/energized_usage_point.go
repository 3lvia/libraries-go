...
const EnergizedUsagePointAvroCRC64Fingerprint = "#\x06\x9a\x9d\xf2O#A"
...
func (r EnergizedUsagePoint) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"mrid\",\"type\":[\"null\",\"string\"]}],\"name\":\"LowVoltageOutageEventsLvisToElvia.Kafka.Dto.EnergizedUsagePoint\",\"type\":\"record\"}"
}

func (r EnergizedUsagePoint) SchemaName() string {
	return "LowVoltageOutageEventsLvisToElvia.Kafka.Dto.EnergizedUsagePoint"
}
