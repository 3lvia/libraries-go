...
const ActualPeriodAvroCRC64Fingerprint = "_\xba\xd3v\xb1\xcf̒"
...
func (r ActualPeriod) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"end\",\"type\":[\"null\",\"string\"]},{\"default\":null,\"name\":\"start\",\"type\":[\"null\",\"string\"]}],\"name\":\"LowVoltageOutageEventsLvisToElvia.Kafka.Dto.ActualPeriod\",\"type\":\"record\"}"
}

func (r ActualPeriod) SchemaName() string {
	return "LowVoltageOutageEventsLvisToElvia.Kafka.Dto.ActualPeriod"
}
