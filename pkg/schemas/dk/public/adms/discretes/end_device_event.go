...
const EndDeviceEventAvroCRC64Fingerprint = "\x12LM\xbf\xe0\xd8\x12_"
...
func (r EndDeviceEvent) Schema() string {
	return "{\"fields\":[{\"default\":null,\"name\":\"UsagePoint\",\"type\":[\"null\",{\"fields\":[{\"default\":null,\"name\":\"MRID\",\"type\":[\"null\",\"string\"]}],\"name\":\"UsagePoint\",\"type\":\"record\"}]}],\"name\":\"SmokeTests.Kafka.Dto.TelemetryScada.EndDeviceEvent\",\"type\":\"record\"}"
}

func (r EndDeviceEvent) SchemaName() string {
	return "SmokeTests.Kafka.Dto.TelemetryScada.EndDeviceEvent"
}
