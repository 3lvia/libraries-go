...
func (r *UnionNullEndDeviceEvent) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionNullEndDeviceEventTypeEnumEndDeviceEvent:
		return json.Marshal(map[string]interface{}{"SmokeTests.Kafka.Dto.TelemetryScada.EndDeviceEvent": r.EndDeviceEvent})
	}
...
func (r *UnionNullEndDeviceEvent) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["SmokeTests.Kafka.Dto.TelemetryScada.EndDeviceEvent"]; ok {
		r.UnionType = 1
